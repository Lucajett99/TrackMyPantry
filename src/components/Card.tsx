...
const Card: React.FC<CardProps> = ({ name, description, quantity}) => {
      ...
      <IonCol>
        <IonCard>
          ...
          <IonCardContent>
            ...
            <IonRow>
            <IonCol>
                <IonButton fill="outline" size="small" onClick={addProduct} style={{float: "left"}}> <IonIcon icon={star}/> </IonButton>
              </IonCol>
              <IonCol>
                <IonButton fill="outline" size="small" onClick={rating} style={{float: "right"}}> Add </IonButton>
              </IonCol>
            </IonRow>
          </IonCardContent>
        </IonCard>
